...
from app.models import (
    Action, ActionEvent, ApprovalRequest, Record, Resource, ResourceDependency,
...
def reset(db: Session) -> dict:
    for model in (ActionEvent, Snapshot, ApprovalRequest, Action, Record,
                  ResourceDependency, Resource, UserSession, User):
    ...
    return {"users": len(USERS), "resources": len(RESOURCES),
            ...
            "records": sum(r[6] for r in RESOURCES)}
